...
import 'package:flutter_nasa/firestore/firestore_helper.dart';
...
class _MyHomeState extends State<MyHome> {
  ...
  Future<void> showEditDialog(EventModel event) async {
    TextEditingController judulController =
        TextEditingController(text: event.judul);
    TextEditingController keteranganController =
        TextEditingController(text: event.keterangan);
    TextEditingController tanggalController =
        TextEditingController(text: event.tanggal);
    TextEditingController pembicaraController =
        TextEditingController(text: event.pembicara);
